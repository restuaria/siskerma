...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?php echo base_url('dosen/dashboard') ?>" class="logo d-flex align-items-center">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="mydata" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo base_url('dosen/dashboard/mou') ?>">
                            <i class="bi bi-circle"></i><span>MOU</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('dosen/dashboard/moa') ?>">
                            <i class="bi bi-circle"></i><span>MOA</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('dosen/dashboard/ia') ?>">
            ...
            <li class="nav-item">
                ...
                <ul id="datalain" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo base_url('dosen/dashboard/dlmou') ?>">
                            <i class="bi bi-circle"></i><span>MOU</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('dosen/dashboard/dlmoa') ?>">
                            <i class="bi bi-circle"></i><span>MOA</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('dosen/dashboard/dlia') ?>">
                            <i class="bi bi-circle"></i><span>IA</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url('dosen/panduan') ?>">
