...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('mahasiswa/template', 'mahasiswa/dashboard', $data);
    }
    function mou()
    {
        $id_user =  $this->session->userdata('user_id');
        ...
        $this->template->load('mahasiswa/template', 'mahasiswa/v_mou', $data);
    }
    ...
    function dlmou()
    {
        ...
        $this->template->load('mahasiswa/template', 'mahasiswa/v_dl', $data);
    }
    ...
    function proses_tambah()
    {
        ...
        if (!$this->upload->do_upload('file')) {
            redirect('mahasiswa/dashboard/mou?alert=gagal');
        } else {
            ...
            if ($jenis == 1) {
                redirect('mahasiswa/dashboard/mou?alert=berhasil');
            } elseif ($jenis == 2) {
                redirect('mahasiswa/dashboard/moa?alert=berhasil');
            } elseif ($jenis == 3) {
                redirect('mahasiswa/dashboard/ia?alert=berhasil');
            }
        }
    }
}
